...
jobs = [
    ...
    {"id": "6", "title": "QA инженер", "specialty": "testing", "company": "9", "salary_from": "80000",
     "salary_to": "120000", "posted": "2022-03-11", "skills": "QA, Python, SQL, Git",
	 "description": "<p>Наши Заказчики -  почти все компании России. Ищем инженера по тестированию наших продуктов.</p> <p><b>Что ждем от кандидата:</b></p> <ul> <li>Опыт разработки и написания тестовых сценариев на Java;</li> <li>Опыт работы с жизненным циклом разработки ПО;</li> <li>Практический опыт работы с фреймворками (TestNG, MochaJS, Cucumber);</li> <li>Умение оценивать объем и сроки работ;</li> <li>опыт разработки, написания и реализации автоматизированных тест-кейсов.</li> </ul> <p><b>Чем будете заниматься:</b></p> <ul> <li>​Тестирование решений для обработки данных на соответствие бизнес-требованиям.</li> <li>Предоставление отчетов о тестировании на регулярной основе, с описанием хода тестирования, проблем и рисков.</li> </ul> <p><b>Плюшки:</b></p> <ul> <li>Гибкий рабочий график;</li> <li>Удаленное сотрудничество с выстроенными процессами;</li> <li>Оформление по ТК РФ.</li> <li>Амбициозные проекты, интересные с профессиональной точки зрения задачи;</li> <li>Команда профессионалов.</li> </ul> <p>В отклике обязательно сопроводительное письмо, почему именно вы подходите на эту вакансию.</p>"},
]
...
companies = [
    ...
    {"id": "8", "title": "primalassault", "logo": "logo8.png","employee_count": "13", "location": "Москва",
     ...
     "owner": 9 },
    {"id": "9", "title": "2ГИС", "logo": "logo9.png","employee_count": "800", "location": "Новосибирск",
     "description": "Главный продукт компании — городской информационный сервис 2ГИС. Он объединяет справочник организаций и точную карту города.",
     "owner": 10}
